...
! function(t) {
    ...
    t.cleanData = (e = t.cleanData, function(i) {
        ...
        _classes: function(e) {
            ...
            function n(n, o) {
                var a, r;
                for (r = 0; r < n.length; r++) a = s.classesElementLookup[n[r]] || t(), e.add ? (e.element.each(function(e, i) {
    ...
    ! function() {
        ...
        t.position = {
            ...
            return _ = 9 === (b = (v = y)[0]).nodeType ? {
                ...
                offset: v.offset()
            }, y[0].preventDefault && (e.at = "left top"), p = _.width, f = _.height, g = _.offset, m = t.extend({}, g), t.each(["my", "at"], function() {
                ...
                "right" === e.my[0] ? D.left -= r : "center" === e.my[0] && (D.left -= r / 2), "bottom" === e.my[1] ? D.top -= h : "center" === e.my[1] && (D.top -= h / 2), D.left += I[0], D.top += I[1], n = {
                    marginLeft: d,
                    marginTop: _
    ...
    function v(t) {
        return null == t ? t + "" : "object" == typeof t ? l[h.call(t)] || "object" : typeof t
    }
    ...
    m.style.cssText = "background-color:rgba(1,1,1,.5)", g.rgba = m.style.backgroundColor.indexOf("rgba") > -1, _(p, function(t, e) {
        ...
        parse: function(t, e, i, s) {
            ...
            var n = this,
                o = v(t),
                l = this._rgba = [];
            return void 0 !== e && (t = [t, e, i, s], o = "array"), "string" === o ? this.parse(y(t) || a._default) : "array" === o ? (_(p.rgba.props, function(e, i) {
                l[i.idx] = b(t[i.idx], i)
            }), this) : "object" === o ? (_(p, t instanceof d ? function(e, i) {
        ...
        is: function(t) {
            var e = d(t),
                i = !0,
                s = this;
            return _(p, function(t, n) {
                var o, a = e[n.cache];
                return a && (o = s[n.cache] || n.to && n.to(s._rgba) || [], _(n.props, function(t, e) {
        ...
        d.fn[t] = function(t) {
            ...
            d.fn[e] || (d.fn[e] = function(s) {
                var n, o, a, r, l = v(s);
                return o = (n = this[r = "alpha" === e ? this._hsla ? "hsla" : "rgba" : t]())[i.idx], "undefined" === l ? o : ("function" === l && (l = v(s = s.call(this, o))), null == s && i.empty ? this : ("string" === l && (a = c.exec(s)) && (s = o + parseFloat(a[2]) * ("+" === a[1] ? 1 : -1)), n[i.idx] = s, this[r](n)))
            })
        })
    }), d.hook = function(t) {
        var e = t.split(" ");
        _(e, function(t, e) {
            r.cssHooks[e] = {
                    ...
                    if ("transparent" !== i && ("string" !== v(i) || (s = y(i)))) {
                        if (i = d(s || i), !g.rgba && 1 !== i._rgba[3]) {
                            for (n = "backgroundColor" === e ? t.parentNode : t;
                                ...
                                o = r.css(n, "backgroundColor"), n = n.parentNode
                            } catch (t) {}
                ...
                t.colorInit || (t.start = d(t.elem, e), t.end = d(t.end), t.colorInit = !0), r.cssHooks[e].set(t.elem, t.start.transition(t.end, t.pos))
            }
        })
    }, d.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor"), r.cssHooks.borderColor = {
        expand: function(t) {
            var e = {};
            return _(["Top", "Right", "Bottom", "Left"], function(i, s) {
                e["border" + s + "Color"] = t
            }), e
        }
    }, a = r.Color.names = {
        ...
        function() {
            ...
            function n(t) {
                ...
                if (n && n.length && n[0] && n[n[0]])
                    for (i = n.length; i--;) "string" == typeof n[e = n[i]] && (o[(s = e, s.replace(/-([\da-z])/gi, function(t, e) {
                        return e.toUpperCase()
                    }))] = n[e]);
                else
        ...
        function() {
            ...
            t.expr && t.expr.pseudos && t.expr.pseudos.animated && (t.expr.pseudos.animated = (e = t.expr.pseudos.animated, function(i) {
                ...
                effect: function() {
                    ...
                    if (t.fx.off || !s) return l ? this[l](e.duration, r) : this.each(function() {
                        r && r.call(this)
                    });
                    ...
                    function u(i) {
                        ...
                        function a() {
                            "function" == typeof r && r.call(o[0]), "function" == typeof i && i()
                        }
                        e.mode = h.shift(), !1 === t.uiBackCompat || n ? "none" === e.mode ? (o[l](), a()) : s.call(o[0], e, function() {
                            o.removeData(k), t.effects.cleanUp(o), "hide" === e.mode && o.hide(), a()
                        }) : (o.is(":hidden") ? "hide" === l : "show" === l) ? (o[l](), a()) : s.call(o[0], e, a)
                    }
    ...
    t.effects, t.effects.define("blind", "hide", function(e, i) {
        ...
        for (t.effects.createPlaceholder(a), o = a.css(m), u || (u = a["top" === m ? "outerHeight" : "outerWidth"]() / 3), h && ((n = {
                opacity: 1
            })[m] = o, a.css("opacity", 0).css(m, _ ? 2 * -u : 2 * u).animate(n, f, g)), l && (u /= Math.pow(2, d - 1)), (n = {})[m] = o; v < d; v++)(s = {})[m] = (_ ? "-=" : "+=") + u, a.animate(s, f, g).animate(n, f, g), u = l ? 2 * u : u / 2;
        l && ((s = {
            opacity: 0
        ...
        var s = t(this),
            ...
            c = 1,
            u = s.queue().length;
        for (!o && s.is(":visible") || (s.css("opacity", 0).show(), h = 1); c < r; c++) s.animate({
            opacity: h
        }, l, e.easing), h = 1 - h;
        s.animate({
            opacity: h
    ...
    t.ui.keyCode = {
        ...
        nextPage: function(e) {
            var i, s, n;
            this.active ? this.isLastItem() || (this._hasScroll() ? (s = this.active.offset().top, n = this.element.innerHeight(), 0 === t.fn.jquery.indexOf("3.2.") && (n += this.element[0].offsetHeight - this.element.outerHeight()), this.active.nextAll(".ui-menu-item").each(function() {
                return (i = t(this)).offset().top - s - n < 0
            }), this.focus(e, i)) : this.focus(e, this._menuItems(this.activeMenu)[this.active ? "last" : "first"]())) : this.next(e)
        },
        previousPage: function(e) {
            var i, s, n;
            this.active ? this.isFirstItem() || (this._hasScroll() ? (s = this.active.offset().top, n = this.element.innerHeight(), 0 === t.fn.jquery.indexOf("3.2.") && (n += this.element[0].offsetHeight - this.element.outerHeight()), this.active.prevAll(".ui-menu-item").each(function() {
                return (i = t(this)).offset().top - s + n > 0
            }), this.focus(e, i)) : this.focus(e, this._menuItems(this.activeMenu).first())) : this.next(e)
        },
        _hasScroll: function() {
        ...
        _filterMenuItems: function(e) {
            ...
            return this.activeMenu.find(this.options.items).filter(".ui-menu-item").filter(function() {
                return s.test(String.prototype.trim.call(t(this).children(".ui-menu-item-wrapper").text()))
            })
        }
    });
            ...
            this.isMultiLine = o || !a && this._isContentEditable(this.element), this.valueMethod = this.element[o || a ? "val" : "text"], this.isNewMenu = !0, this._addClass("ui-autocomplete-input"), this.element.attr("autocomplete", "off"), this._on(this.element, {
                ...
                menufocus: function(e, i) {
                    ...
                    n = i.item.data("ui-autocomplete-item"), !1 !== this._trigger("focus", e, {
                        item: n
                    }) && e.originalEvent && /^key/.test(e.originalEvent.type) && this._value(n.value), (s = i.item.attr("aria-label") || n.value) && String.prototype.trim.call(s).length && (this.liveRegion.children().hide(), t("<div>").text(s).appendTo(this.liveRegion))
                },
    ...
    t.extend(t.ui, {
        ...
        _updateDatepicker: function(e) {
            ...
            o.length > 0 && H.apply(o.get(0)), e.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), n > 1 && e.dpDiv.addClass("ui-datepicker-multi-" + n).css("width", 17 * n + "em"), e.dpDiv[(1 !== s[0] || 1 !== s[1] ? "add" : "remove") + "Class"]("ui-datepicker-multi"), e.dpDiv[(this._get(e, "isRTL") ? "add" : "remove") + "Class"]("ui-datepicker-rtl"), e === t.datepicker._curInst && t.datepicker._datepickerShowing && t.datepicker._shouldFocusInput(e) && e.input.trigger("focus"), e.yearshtml && (i = e.yearshtml, setTimeout(function() {
        ...
        _generateHTML: function(e) {
            var i, s, n, o, a, r, l, h, c, u, d, p, f, g, m, _, v, b, y, w, x, k, C, D, I, T, P, M, S, H, z, A, O, N, E, W, F, L, R, Y = new Date,
                ...
                et = e.drawYear;
            if (tt < 0 && (tt += 12, et--), Z)
                for (i = this._daylightSavingAdjust(new Date(Z.getFullYear(), Z.getMonth() - V[0] * V[1] + 1, Z.getDate())), i = J && i < J ? J : i; this._daylightSavingAdjust(new Date(et, tt, 1)) > i;) --tt < 0 && (tt = 11, et--);
            for (e.drawMonth = tt, e.drawYear = et, s = this._get(e, "prevText"), s = U ? this.formatDate(s, this._daylightSavingAdjust(new Date(et, tt - $, 1)), this._getFormatConfig(e)) : s, n = this._canAdjustMonth(e, -1, et, tt) ? t("<a>").attr({
                    class: "ui-datepicker-prev ui-corner-all",
                    "data-handler": "prev",
                    "data-event": "click",
                    title: s
                }).append(t("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w")).text(s))[0].outerHTML : K ? "" : t("<a>").attr({
                    class: "ui-datepicker-prev ui-corner-all ui-state-disabled",
                    title: s
                }).append(t("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w")).text(s))[0].outerHTML, o = this._get(e, "nextText"), o = U ? this.formatDate(o, this._daylightSavingAdjust(new Date(et, tt + $, 1)), this._getFormatConfig(e)) : o, a = this._canAdjustMonth(e, 1, et, tt) ? t("<a>").attr({
                    class: "ui-datepicker-next ui-corner-all",
                    "data-handler": "next",
                    "data-event": "click",
                    title: o
                }).append(t("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e")).text(o))[0].outerHTML : K ? "" : t("<a>").attr({
                    class: "ui-datepicker-next ui-corner-all ui-state-disabled",
                    title: o
                }).append(t("<span>").attr("class", "ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e")).text(o))[0].outerHTML, r = this._get(e, "currentText"), l = this._get(e, "gotoCurrent") && e.currentDay ? Q : B, r = U ? this.formatDate(r, l, this._getFormatConfig(e)) : r, h = "", e.inline || (h = t("<button>").attr({
                    type: "button",
                    class: "ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all",
                    "data-handler": "hide",
                    "data-event": "click"
                }).text(this._get(e, "closeText"))[0].outerHTML), c = "", q && (c = t("<div class='ui-datepicker-buttonpane ui-widget-content'>").append(j ? h : "").append(this._isInRange(e, l) ? t("<button>").attr({
                    type: "button",
                    class: "ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all",
                    "data-handler": "today",
                    "data-event": "click"
                }).text(r) : "").append(j ? "" : h)[0].outerHTML), u = parseInt(this._get(e, "firstDay"), 10), u = isNaN(u) ? 0 : u, d = this._get(e, "showWeek"), p = this._get(e, "dayNames"), f = this._get(e, "dayNamesMin"), g = this._get(e, "monthNames"), m = this._get(e, "monthNamesShort"), _ = this._get(e, "beforeShowDay"), v = this._get(e, "showOtherMonths"), b = this._get(e, "selectOtherMonths"), y = this._getDefaultDate(e), w = "", k = 0; k < V[0]; k++) {
                for (C = "", this.maxRows = 4, D = 0; D < V[1]; D++) {
                    ...
                    for (P += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === k ? j ? a : n : "") + (/all|right/.test(T) && 0 === k ? j ? n : a : "") + this._generateMonthYearHeader(e, tt, et, J, Z, k > 0 || D > 0, g, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", M = d ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", x = 0; x < 7; x++) M += "<th scope='col'" + ((x + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + p[S = (x + u) % 7] + "'>" + f[S] + "</span></th>";
            ...
            if (v || (w += x + (!o && m && _ ? "" : "&#xa0;")), !t.yearshtml)
                if (t.yearshtml = "", o || !_) w += "<span class='ui-datepicker-year'>" + i + "</span>";
                    ...
                    for (u = this._get(t, "yearRange").split(":"), d = (new Date).getFullYear(), f = (p = function(t) {
                            ...
                            return isNaN(e) ? d : e
                        })(u[0]), g = Math.max(f, p(u[1] || "")), f = s ? Math.max(f, s.getFullYear()) : f, g = n ? Math.min(g, n.getFullYear()) : g, t.yearshtml += "<select class='ui-datepicker-year' aria-label='" + y + "' data-handler='selectYear' data-event='change'>"; f <= g; f++) t.yearshtml += "<option value='" + f + "'" + (f === i ? " selected='selected'" : "") + ">" + f + "</option>";
    ...
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        drag: function(e, i, s) {
            ...
            for (d = s.snapElements.length - 1; d >= 0; d--) h = (l = s.snapElements[d].left - s.margins.left) + s.snapElements[d].width, u = (c = s.snapElements[d].top - s.margins.top) + s.snapElements[d].height, _ < l - g || m > h + g || b < c - g || v > u + g || !t.contains(s.snapElements[d].item.ownerDocument, s.snapElements[d].item) ? (s.snapElements[d].snapping && s.options.snap.release && s.options.snap.release.call(s.element, e, t.extend(s._uiHash(), {
            ...
            })), s.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (n = Math.abs(c - b) <= g, o = Math.abs(u - v) <= g, a = Math.abs(l - _) <= g, r = Math.abs(h - m) <= g, n && (i.position.top = s._convertPositionTo("relative", {
                ...
                top: 0,
                left: h
            }).left)), p = n || o || a || r, "outer" !== f.snapMode && (n = Math.abs(c - v) <= g, o = Math.abs(u - b) <= g, a = Math.abs(l - m) <= g, r = Math.abs(h - _) <= g, n && (i.position.top = s._convertPositionTo("relative", {
                top: c,
                left: 0
            }).top), o && (i.position.top = s._convertPositionTo("relative", {
    ...
    t.ui.droppable, t.widget("ui.progressbar", {
        ...
        _mouseDrag: function(e) {
            ...
            if (this.position = this._generatePosition(e), this.positionAbs = this._convertPositionTo("absolute"), this.options.axis && "y" === this.options.axis || (this.helper[0].style.left = this.position.left + "px"), this.options.axis && "x" === this.options.axis || (this.helper[0].style.top = this.position.top + "px"), this._contactContainers(e), null !== this.innermostContainer)
                for (a.scroll && !1 !== this._scroll(e) && (this._refreshItemPositions(!0), t.ui.ddmanager && !a.dropBehaviour && t.ui.ddmanager.prepareOffsets(this, e)), this.dragDirection = {
